...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Parvathi K — Senior UX/UI & Product Designer" },
      {
        name: "description",
        content:
      ...
      { name: "author", content: "Parvathi Krishnan K" },
      { property: "og:title", content: "Parvathi K — Senior UX/UI & Product Designer" },
      {
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&family=Inter+Tight:wght@400;500;600;700;800;900&family=JetBrains+Mono:wght@400;500&family=Caveat:wght@500;700&display=swap",
      },
